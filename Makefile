...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	@# The helm chart cluster role rules are generated from the same markers so they can not drift.
	@{ echo '{{/* Generated by <make manifests> from config/rbac/role.yaml, do not edit. */}}'; \
	   echo '{{- define "swagger-hub-controller.rbacRules" -}}'; \
	   sed -n '/^rules:/,$$p' config/rbac/role.yaml | tail -n +2; \
	   echo '{{- end }}'; } > chart/swagger-hub-controller/templates/_rbac-rules.tpl
